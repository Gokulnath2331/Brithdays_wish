    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Bommi</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Bommi</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Bommi 💖</h2>
          <p className="final-subtitle"> No matter what happens, I will always be with you.🫂✨</p>
        </section>
      </div>
